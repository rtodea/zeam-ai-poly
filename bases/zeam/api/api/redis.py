...
from zeam.redis_client import async_client_context
...
async def redis_stats():
    # Count of keys
    async with async_client_context() as redis:
        try:
...
async def get_redis_key(redis_key: str):
    async with async_client_context() as redis:
        try:
...
async def delete_redis_key(redis_key: str):
    """
